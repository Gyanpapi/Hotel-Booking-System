...
<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $dir= "hotel_images/" . basename($image);
		$insert = $conn->prepare("INSERT INTO hotels (name,image,description,location)
		VALUES (:name,:image,:description,:location)");
		$insert->execute([
			":name" => $name,
      ":image" => $image,
        ...
        <div class="col">
          ...
          <form method="POST" action="create-hotels.php" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4 mt-4">
                  ...
                  <input type="text" name="location" class="form-control" id="form2Example1"/>
