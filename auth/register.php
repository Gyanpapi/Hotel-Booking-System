...
<?php
  ...
  if(isset($_POST['submit']))
  {
     if(empty($_POST['username']) OR empty($_POST['email'])  OR empty($_POST['password']))
	 {
		...
		$insert = $conn->prepare("INSERT INTO users (username,email,mypassword,pp_account)
		VALUES (:username,:email,:mypassword,:pp_account)");
		$insert->execute([
			":username" => $username,
			":email" => $email,
			":mypassword" => $password,
	    		...
	    		<div class="col-md-6 mt-5">
						<form action="register.php" method="POST" class="appointment-form" style="margin-top: -568px;">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
			    					    <input type="text" name="pp_account" class="form-control" placeholder="PayPal account">
			    				    </div>
								</div>
